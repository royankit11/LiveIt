                    ...
                    HStack {
                        ZStack {
                            ...
                            HStack {
                                ...
                                TextField("Last Name", text: $lastName).padding().font(.custom("DIN Alternate", size: 25))
                            }
                    ...
                    HStack {
                        VStack {
                            ...
                            Button {
                                ...
                                model.registerUser(firstName: firstName, lastName: lastName, username: username, password: password, age: Int(age)!, gender: gender, height: Int(height)!, weight: Int(weight)!, activity: activity)
                                register = true
                            } label: {
                                ZStack {
                                    Capsule()
